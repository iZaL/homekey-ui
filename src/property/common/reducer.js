...
const initialState = {
  ...
  sortOptions: [
    ...
    {
      key: 'price-asc',
      value: I18n.t('price-asc'),
    },
    {
      key: 'price-desc',
      value: I18n.t('price-desc'),
    },
    {
      key: 'oldest',
      value: I18n.t('oldest'),
...
export default function propertyReducer(state = initialState, action = {}) {
  switch (action.type) {
    ...
    case ACTION_TYPES.PROPERTY_MAPVIEW_CHANGE:
      return {
        ...state,
        mapView: action.value ? action.value !== 'list' : !state.mapView,
      };
    case ACTION_TYPES.PROPERTY_SET_SORT_OPTION:
      return {
        ...state,
...
let initialFilters = {
  propertyTypes,
  selectedPropertyType: propertyTypes[0].key,
  filters,
  amenities,
  nearByPlaces,
  genders,
