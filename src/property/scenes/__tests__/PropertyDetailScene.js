...
import PropertyDetailScene from '../PropertyDetailScene';
...
const properties = [
  {
    ...
    meta: {
      ...
      description:
        'Beautiful new apartment from rent in Jabriya near McDonalds',
      price: 200,
      bedroom: 2,
      bathroom: 1,
      kitchen: 1,
...
test('renders PropertyDetailScene Component', () => {
  const tree = renderer
    .create(
      <PropertyDetailScene
        ...
        setSceneType={() => {}}
        country={{abbr: 'KW', fullName: 'Kuwait', currency: 'KD'}}
      />,
    )
    .toJSON();
